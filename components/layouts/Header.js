    ...
    return (
        <>
            <div style={{ marginBottom: `${postionSticky ? "100px" : "0px"}` }}>
                <nav className={`navbar ${postionSticky ? "py-3" : "py-4"} ${postionSticky ? "fixed-top" : ""}`} style={{ backgroundColor: `${postionSticky ? "White" : "transparent"}`, borderBottom: `${postionSticky ? "1px solid rgba(0, 0, 0, 0.12)" : ""}` }}>
